...
def end_of_game_handler(result: GameResult):
    print(f'Questions asked: {result.questions_passed}. Mistakes made: {result.mistake_made}.')
    print(f'You wom!' if result.won else "you lost!")


game = Game(file_path='.\Questions.csv', allowed_mistakes=3, end_of_game_event=end_of_game_handler)
